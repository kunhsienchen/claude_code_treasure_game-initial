      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
            {boxes.map((box) => (
              <motion.div
                ...
                onHoverStart={() => setHoveredBoxId(box.id)}
                onHoverEnd={() => setHoveredBoxId(null)}
              ...
              >
                <motion.div
                  ...
                  className="relative"
                >
                  {!box.isOpen && hoveredBoxId === box.id && (
                    <motion.img
                      src={keyImage}
                      alt="Key"
                      ...
                      className="absolute w-12 h-12 object-contain drop-shadow-md z-10 pointer-events-none"
            ...
            >
              <div className="mb-4 p-6 bg-amber-200/80 backdrop-blur-sm rounded-xl shadow-lg border-2 border-amber-400">
                ...
                <p className="text-lg font-semibold text-amber-900 mb-2">
                  Result: <span className={`${score > 0 ? 'text-green-600' : score === 0 ? 'text-amber-600' : 'text-red-600'}`}>
